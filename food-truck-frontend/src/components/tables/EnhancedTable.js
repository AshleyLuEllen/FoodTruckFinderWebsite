...
import { Table, TableContainer, TableCell, TableBody, TableRow, TablePagination, Paper, Checkbox, Button } from '@material-ui/core';
                                            ...
                                            <div style={{ display: 'flex' }}>
                                                {this.props.rowActions.map(action =>
                                                    <Button
                                                        ...
                                                        size="small"
                                                        color={action.color}
                                                        style={{ width: "auto", height: "auto", margin: "0px", marginRight: "5px" }}
                                                        onClick={e => action.action && action.action(e, row[action.references])}
                                                    >
                                                        {action.label}
                                                    </Button>
                                                )}
